...
class CriarPokemonViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate{
    ...
    @IBAction func addTapped(_ sender: Any) {
        ...
        addPokemon = Pokemon(name: nameField.text!, type: typeLabelValue.text!, subType: typeLabelValue.text!, description: descricaoField.text!, xp: XPvalue!, hp: HPvalue!, power: powerValue!, evolution: evolutionField.text ?? "None")
